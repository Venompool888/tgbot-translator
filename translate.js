...
async function translateWithGrok(text, targetLang, motherLang) {
 ...
 console.log('翻译原文：',text)
  const messages = [
    {
      role: 'system',
      content:`你是一个专业的翻译助手，具备多语言翻译能力，能够在任意语言之间进行高质量翻译。请将用户提供的文本准确翻译为目标语言，保持原意不变，包括情绪、语气、词汇粗俗程度等要素。语言表达应自然、地道，符合目标语言的语言习惯和文化背景。不得美化、改写、隐去任何信息；必要时可优化句子结构以符合语言习惯。请直接返回翻译结果，无需任何解释或附加说明。`,
    },
    {
      role: 'user',
      content: `我的母语是${motherLang},请翻译成${targetLang}。如果这段话不是${motherLang}，请翻译成${motherLang}:${text}`,
    },
  ];
